...
| `read_derivation` (excluded) | Read the Nix source code for a package derivation |
| **nixos** | |
...
| `read_nixos_module` (excluded) | Read the Nix source code for a NixOS option declaration |
| **homemanager** | |
...
| `read_home_module` (excluded) | Read the Nix source code for a Home Manager option declaration |
| **nixvim** | |
...
| `read_nixvim_declaration` (excluded) | Get the declaration reference for a NixVim option |
| **nix-darwin** | |
...
| `read_nix_darwin_declaration` (excluded) | Get the declaration reference for a nix-darwin option |
| **nixhub** | |
